...
/**
 * Created by ssv i3-210 on 11/1/2017.
 */
...
public class TripVo {
    ...
    public String getBookLoad() {
        return bookLoad;
    }

    public void setBookLoad(String bookLoad) {
        this.bookLoad = bookLoad;
    }
    ...
    public String getTollgateAmount() {
        return tollgateAmount;
    }

    public void setTollgateAmount(String tollgateAmount) {
